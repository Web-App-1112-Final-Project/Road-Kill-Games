...
const { up, down, left, right, start, end, addScore, hit, resetScore, addSpeed } = playerSlice.actions;
...
export { player, start as startAction, end as endAction, addScore, hit, resetScore, addSpeed }
